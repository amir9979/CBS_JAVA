...
public class ConflictManagerTest {
    ...
    public void goalConflict(){
        ...
        */
        ...
        /*      = Test actual values =  */
        Assert.assertTrue(ConflictAvoidance.equalsAllConflicts(expectedSet, conflictAvoidanceTable.conflictAvoidanceTable.getAllConflicts()));
    ...
    public void TwoAgentsWith4VertexConflicts_graphH() {
        ...
        */
        ...
        /*      = Copy constructor =      */
        ConflictManager copiedTable = new ConflictManager(conflictAvoidanceTable);
        Assert.assertTrue(ConflictAvoidance.equalsAllConflicts(conflictAvoidanceTable.conflictAvoidanceTable.getAllConflicts(), copiedTable.conflictAvoidanceTable.getAllConflicts()));
        ...
        Assert.assertTrue(ConflictAvoidance.equalsAllConflicts(expectedSet, copiedTable.conflictAvoidanceTable.getAllConflicts()));
