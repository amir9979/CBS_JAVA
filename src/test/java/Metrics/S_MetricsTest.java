...
class S_MetricsTest {
    ...
    void writeSomeInstanceReports(boolean commitThem) throws IOException {
        ...
        ir4.putStingValue("iName", "ir4");
        ir4.putStingValue("iName", "new name"); // iName = new name
