...
import Solvers.ConstraintsAndConflicts.DataStructures.TimeLocationTables;
import Solvers.Move;
...
public class ConflictManager implements I_ConflictManager {
    ...
    /*  = Data structures =   */
    public final ConflictAvoidance conflictAvoidanceTable;
    ...
    public ConflictManager(ConflictSelectionStrategy conflictSelectionStrategy) {
         ...
         */
        this.conflictAvoidanceTable = new ConflictAvoidance();
    ...
    public ConflictManager(ConflictManager other){
        ...
        this.conflictAvoidanceTable = other.conflictAvoidanceTable.copy();
    ...
    public void addPlan(SingleAgentPlan singleAgentPlan) {
        ...
        this.conflictAvoidanceTable.removeAgentConflicts(singleAgentPlan.agent);
    ...
    /**
     * = Adds =
     * 2. All {@link A_Conflict} for every other {@link Agent} that it conflicts with to {@link #conflictAvoidanceTable}
     ...
     *      2. Add conflicts to both agents in {@link #conflictAvoidanceTable}
        ...
        */
        for (Agent agentMovingToPrevPosition : agentsMovingToPrevLocations) {
            ...
            if ( this.agent_plan.get(agentMovingToPrevPosition).moveAt(time).prevLocation.equals(nextLocation)){
                ...
                this.conflictAvoidanceTable.addConflictToAgent(singleAgentPlan.agent, swappingConflict_addedAgentFirst);
                this.conflictAvoidanceTable.addConflictToAgent(agentMovingToPrevPosition, swappingConflict_addedAgentFirst);

                this.conflictAvoidanceTable.addConflictToAgent(singleAgentPlan.agent, swappingConflict_addedAgentSecond);
                this.conflictAvoidanceTable.addConflictToAgent(agentMovingToPrevPosition, swappingConflict_addedAgentSecond);
            }
        }
    }
    ...
    private void addVertexConflicts(TimeLocation timeLocation, Agent agent, Set<Agent> agentsAtTimeLocation) {
        ...
        for (Agent agentConflictsWith : agentsAtTimeLocation) {
            ...
            this.conflictAvoidanceTable.addConflictToAgent(agent, vertexConflict);
            this.conflictAvoidanceTable.addConflictToAgent(agentConflictsWith, vertexConflict);
        }
    }
    ...
    public A_Conflict selectConflict() {
        return conflictSelectionStrategy.selectConflict(this.conflictAvoidanceTable.getAllConflicts());
    }
